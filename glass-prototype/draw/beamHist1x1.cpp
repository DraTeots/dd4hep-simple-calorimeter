...
int beamHist1x1(){
   // TH1D *hist = new TH1D("hist-gauss","SciGlass 40cm, 1x1 Matrix. ProjectionY of binx=86 [x=84.5..85.5]",1024,0,4096);
   TH1D *hist = new TH1D("hist-gauss","SciGlass 40cm, 1x1 Matrix. ProjectionY of binx=86 [x=84.5..85.5]",1536,0,6144);
