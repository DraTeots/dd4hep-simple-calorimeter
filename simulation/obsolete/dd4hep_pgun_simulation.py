...
class SimConfig:
    ...
    def output_file_name(self):
        return f'{self.file_date}_pgun_PbWO4_{self.particle}_{self.detector_config}_e{self.e_min}-{self.e_max}GeV_center_{self.multiplicity}prt_{self.events_num}evt.edm4hep.root'
